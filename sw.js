...
const APP_SHELL = ['./','./index.html','./styles.css?v=33','./app.js?v=33','./shared-care-core.js?v=17','./shared-care.js?v=17','./frannies-training-update.js?v=2','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
