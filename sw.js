const CACHE_NAME = 'frannies-good-girl-v30';
const APP_SHELL = ['./','./index.html','./styles.css?v=27','./app.js?v=27','./shared-care-core.js?v=10','./shared-care.js?v=10','./frannies-training-update.js?v=1','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
