...
const APP_SHELL = ['./','./index.html','./styles.css?v=38','./app.js?v=34','./shared-care-core.js?v=18','./sitter-mode.js?v=3','./shared-care.js?v=20','./frannies-training-update.js?v=2','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
