const CACHE_NAME = 'frannies-good-girl-v25';
const APP_SHELL = ['./','./index.html','./styles.css?v=25','./app.js?v=25','./shared-care-core.js?v=6','./shared-care.js?v=6','./frannies-training-update.js?v=1','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
