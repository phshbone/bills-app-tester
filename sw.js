const CACHE_NAME = 'frannies-good-girl-v24';
const APP_SHELL = ['./','./index.html','./styles.css?v=24','./app.js?v=24','./shared-care-core.js?v=5','./shared-care.js?v=5','./frannies-training-update.js?v=1','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
