const CACHE_NAME = 'frannies-good-girl-v36';
const APP_SHELL = ['./','./index.html','./styles.css?v=32','./app.js?v=32','./shared-care-core.js?v=16','./shared-care.js?v=16','./frannies-training-update.js?v=1','./manifest.json','./assets/frannie-background.webp','./assets/frannie-photo.webp','./assets/icon-192.png','./assets/icon-512.png'];
